...
namespace boost {
	...
	namespace optional_detail {
		...
		protected:
			...
			// No-throw (assuming T::~T() doesn't)
			void assign(boost::none_t) BOOST_NOEXCEPT { destroy(); }
...
template<class T>
class optional : public boost::optional_detail::optional_base<T>
{
    typedef boost::optional_detail::optional_base<T> base ;
  ...
  public :
    ...
    // Creates an optional<T> uninitialized.
    // No-throw
    optional(boost::none_t none_ ) BOOST_NOEXCEPT : base(none_) {}
  ...
  explicit optional ( Expr&& expr, 
                      BOOST_DEDUCED_TYPENAME boost::disable_if_c<
                        (boost::is_base_of<boost::optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME boost::decay<Expr>::type>::value) ||
                        boost::is_same<BOOST_DEDUCED_TYPENAME boost::decay<Expr>::type, boost::none_t>::value >::type* = 0
  ) 
   ...
   // No-throw (assuming T::~T() doesn't)
    ...
    BOOST_DEDUCED_TYPENAME boost::disable_if_c<
      boost::is_base_of<boost::optional_detail::optional_tag, BOOST_DEDUCED_TYPENAME boost::decay<Expr>::type>::value || 
        boost::is_same<BOOST_DEDUCED_TYPENAME boost::decay<Expr>::type, boost::none_t>::value,
      optional&
    >::type 
    operator= ( Expr&& expr )
      {
        boost::optional_detail::prevent_binding_rvalue_ref_to_optional_lvalue_ref<T, Expr&&>();
    ...
    optional& operator= ( rval_reference_type val )
      {
        boost::optional_detail::prevent_binding_rvalue_ref_to_optional_lvalue_ref<T, rval_reference_type>();
    ...
    // No-throw (assuming T::~T() doesn't)
    optional& operator= ( boost::none_t none_ ) BOOST_NOEXCEPT
      {
        this->assign( none_ ) ;
        return *this ;
      }
...
template<class T>
inline
bool operator == ( optional<T> const& x, boost::none_t ) BOOST_NOEXCEPT
{ return !x; }

template<class T>
inline
bool operator < ( optional<T> const& x, boost::none_t )
...
template<class T>
inline
bool operator > ( optional<T> const& x, boost::none_t y )
{ return y < x ; }
...
template<class T>
inline
bool operator == ( boost::none_t , optional<T> const& y ) BOOST_NOEXCEPT
{ return !y; }

template<class T>
inline
bool operator < ( boost::none_t , optional<T> const& y )
...
template<class T>
inline
bool operator > ( boost::none_t x, optional<T> const& y )
{ return y < x ; }
